...
export const meta: MetaFunction = () => {
  return [
    { title: "Sign Up | Spectrum Web Co Australia" },
    { name: "description", content: "Create a new account with Spectrum Web Co to access exclusive resources and manage your projects." },
  ];
};
